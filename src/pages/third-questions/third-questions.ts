...
import { FourthQuestionsPage } from '../fourth-questions/fourth-questions';

/**
 * Generated class for the ThirdQuestionsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-third-questions',
  templateUrl: 'third-questions.html',
})
export class ThirdQuestionsPage {

  constructor(public navCtrl: NavController, public navParams: NavParams, public alertCtrl: AlertController ) {
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad ThirdQuestionsPage');
  }
